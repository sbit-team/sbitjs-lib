...
export const call_contract_with_verification = new Serializer(
    "call_contract_with_verification",
    {fee: asset,
    registrar: protocol_id_type("account"),
    receiver: protocol_id_type("contract"),
    value: uint64,
    gasPrice: uint64,
    gas: uint64,
    code: string,
...
export const execute_bid = new Serializer(
    "execute_bid",
    {}
);
export const bid_collateral = new Serializer(
    "bid_collateral",
    {}
);
